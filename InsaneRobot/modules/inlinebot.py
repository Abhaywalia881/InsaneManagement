...
from InsaneRobot.utils.inlinehelper import *
from InsaneRobot.utils.pluginhelpers import fetch, json_prettify
from InsaneRobot import pgram, OPENWEATHERMAP_ID, TIME_API_KEY, SUPPORT_CHAT
...
__MODULE__ = "🔷Inline"
__HELP__ = f"""
 ==>> **INLINE BOT SERVICE OF @Insane_Help** <<==
`I'm more efficient when added as group admin. By the way these commands can be used by anyone in a group via inline.`
   >> Syntax <<
@Insane_Help [command] [query]
   >> Commands Available <<
